...
VALUES
     ...
     (2, 1, N'Senior Java Developer', N'Đang chờ xét duyệt'),
     (3, 1, N'Senior Java Developer', N'Đã từ chối'),
     (5, 1, N'Senior Java Developer', N'Đã chấp nhận'),

     (2, 2, N'React Native Developer', N'Đang chờ xét duyệt'),
     (1, 2, N'React Native Developer', N'Đang chờ xét duyệt'),
     (3, 2, N'React Native Developer', N'Đang chờ xét duyệt'),

     (3, 3, N'DevOps Engineer', N'Đã từ chối'),
     (1, 3, N'DevOps Engineer', N'Đã từ chối'),
     (2, 3, N'DevOps Engineer', N'Đã từ chối'),
     (4, 3, N'DevOps Engineer', N'Đã từ chối'),

     (4, 4, N'Frontend Developer', N'Đã chấp nhận'),
     (2, 4, N'Frontend Developer', N'Đang chờ xét duyệt'),
     (3, 4, N'Frontend Developer', N'Đã chấp nhận'),

     (5, 5, N'Fullstack Developer', N'Đang chờ xét duyệt'),
     (1, 5, N'Fullstack Developer', N'Đang chờ xét duyệt');
